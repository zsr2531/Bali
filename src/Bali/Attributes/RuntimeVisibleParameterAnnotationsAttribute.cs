...
namespace Bali.Attributes
{
    [AutoReader]
    [AutoWriter]
    public sealed class RuntimeVisibleParameterAnnotationsAttribute : JvmAttribute
    {
        public RuntimeVisibleParameterAnnotationsAttribute(ushort nameIndex, IList<IList<AnnotationInfo>> parameterAnnotations)
            : base(nameIndex)
        {
