...
namespace Bali.Attributes
{
    [AutoReader]
    [AutoWriter]
    public sealed class RuntimeInvisibleAnnotationsAttribute : JvmAttribute
    {
        public RuntimeInvisibleAnnotationsAttribute(ushort nameIndex, IList<AnnotationInfo> annotations)
            : base(nameIndex)
        {
